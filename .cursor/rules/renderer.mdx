...
## 2. Use the Preload API (`window.api`) Exclusively for Backend Interaction
...
## 3. Avoid Global Side Effects and Modifications
...
## 4. Follow Standard Next.js/React Practices
...
## 5. No Direct Access to the `data/` Directory
...
## 6. Focus on UI Logic and Presentation
