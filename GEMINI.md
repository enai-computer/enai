The Enai personal library consists of an intent stream (INS), working memory (WOM), long term memory (LOM), and ontological model (OM). So far, we've built things that go into LOM.
