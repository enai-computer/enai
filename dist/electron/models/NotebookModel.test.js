...
(0, vitest_1.describe)('NotebookModel Unit Tests', () => {
    ...
    (0, vitest_1.describe)('create', () => {
        ...
        (0, vitest_1.it)('should throw an error if trying to create a notebook with an existing ID', async () => {
            ...
            await (0, vitest_1.expect)(notebookModel.create(id, 'Second Notebook Same ID', 'Desc2'))
                .rejects
    ...
    (0, vitest_1.describe)('getAll', () => {
        ...
        (0, vitest_1.it)('should retrieve all notebooks ordered by title ascending', async () => {
            ...
            await notebookModel.create((0, crypto_1.randomUUID)(), 'Charlie Notebook', 'Desc C');
            await notebookModel.create((0, crypto_1.randomUUID)(), 'Alpha Notebook', 'Desc A');
            await notebookModel.create((0, crypto_1.randomUUID)(), 'Bravo Notebook', 'Desc B');
            const allNotebooks = await notebookModel.getAll();
