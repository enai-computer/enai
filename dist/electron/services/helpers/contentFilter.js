...
exports.cleanNewsContent = cleanNewsContent;
exports.extractHighlights = extractHighlights;
exports.extractHeadline = extractHeadline;
exports.formatNewsResults = formatNewsResults;
...
function cleanNewsContent(text) {
    ...
    if (reductionPercentage > 50) {
        logger_1.logger.debug(`[ContentFilter] Removed ${reductionPercentage.toFixed(1)}% of content as noise`);
    }
    return cleaned;
}
// Alias for backward compatibility
exports.filterContent = cleanNewsContent;
/**
 ...
 */
function extractHighlights(text, count = 3) {
    if (!text)
        return [];
 ...
 */
function extractHeadline(text, title) {
