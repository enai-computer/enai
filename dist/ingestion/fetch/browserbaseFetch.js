...
async function fetchWithBrowserbase(url) {
    ...
    try {
        ...
        // 2. Connect Puppeteer
        const wsEndpoint = session === null || session === void 0 ? void 0 : session.wsEndpoint;
        if (!wsEndpoint) {
        ...
        try {
            ...
            const sessionId = (_a = session === null || session === void 0 ? void 0 : session.id) !== null && _a !== void 0 ? _a : 'unknown'; // Get session ID safely
        ...
        if (((_c = err === null || err === void 0 ? void 0 : err.response) === null || _c === void 0 ? void 0 : _c.status) === 401) {
        ...
        throw new Error(`Browserbase fetch failed for ${url}: ${(_d = err.message) !== null && _d !== void 0 ? _d : 'Unknown error'}`); // Generic wrapper
    }
    finally {
        ...
        try {
            ...
            logger_1.logger.warn(`[browserbase] Could not release session ${session === null || session === void 0 ? void 0 : session.id}: ${releaseErr.message}`);
        }
    }
}
