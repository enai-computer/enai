...
export class ContentModel {
     ...
     */
    upsertContent(record: ContentRecordInput): Database.RunResult {
     ...
     * @returns The RunResult object from better-sqlite3.
     */
    updateContentStatus(bookmarkId: string, status: ContentStatus, fetchedAt?: Date): Database.RunResult {
        const stmt = this.db.prepare(`
            UPDATE content
     ...
     */
    findByStatuses(statuses: ContentStatus[]): { bookmark_id: string; source_url: string }[] {
