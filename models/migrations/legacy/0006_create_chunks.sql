...
CREATE TABLE chunks (
  ...
  notebook_id TEXT NULLABLE REFERENCES notebooks(id) ON DELETE SET NULL ON UPDATE CASCADE, -- Added NULLABLE FK
...
CREATE INDEX IF NOT EXISTS idx_chunks_notebook_id ON chunks(notebook_id); -- Added index 