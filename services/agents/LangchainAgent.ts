    ...
    async queryStream(
        ...
        try {
            ...
            const standaloneQuestionChain = RunnableSequence.from([
                 ...
                 RunnableSequence.from([
                     ...
                     RunnablePassthrough.assign({
                         standalone_question: RunnableSequence.from([
                              (input: { question: string, chat_history: BaseMessage[]}) => ({ question: input.question, chat_history: input.chat_history }),
                     ...
                     // Step 3: Prepare input for the final answer prompt
                      (input: { question: string, chat_history: BaseMessage[], context: string }) => ({
             ...
             const config: RunnableConfig = { callbacks: [] }; // Add other configs like tags if needed
             if (signal) {
