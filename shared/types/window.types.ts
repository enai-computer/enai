...
/** Pool state for a tab in the global tab pool. */
export enum TabPoolState {
  ACTIVE = 'ACTIVE',     // Has WebContentsView in pool
  INACTIVE = 'INACTIVE', // No WebContentsView, state preserved  
  LOADING = 'LOADING'    // Being activated/created
}
...
export interface TabState {
  ...
  /** Pool state for global tab management. */
  poolState?: TabPoolState;
  /** Last accessed timestamp for LRU tracking. */
  lastAccessed?: number;
  /** Window ID that owns this tab. */
  windowId?: string;
  /** Preserved state for inactive tabs. */
  preservedState?: {
...
export interface ClassicBrowserPayload extends BaseWindowPayload {
  ...
  /** Initial URL to load when creating the first tab (optional). */
  initialUrl?: string;
  /** ID of the tab group object (for WOM composite objects). */
  tabGroupId?: string;
  /** Title of the tab group (generated by AI). */
  tabGroupTitle?: string;
  /** Number of tabs currently active in the global pool. */
