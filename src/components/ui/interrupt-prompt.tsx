    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="absolute left-1/2 flex -translate-x-1/2 overflow-hidden whitespace-nowrap rounded-full border bg-step-1 py-1 text-center text-sm text-step-10"
        >
